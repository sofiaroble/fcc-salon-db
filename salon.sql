...
1124	555-555-5555	Fabio
1125	888-888-8888	Me
\.
...
SELECT pg_catalog.setval('public.appointments_appointment_id_seq', 1008, true);
...
SELECT pg_catalog.setval('public.customers_customer_id_seq', 1145, true);
